...
public class InputManager : MonoBehaviour
{
    ...
    public void PrepareMenu()
    {
        ...
        {
            { "StartGame", new ButtonArea(new Rect(710, 140, 200, 200), ActionStartGame) },
            { "ToRanking", new ButtonArea(new Rect(1010, 140, 200, 200), ActionToRanking) },
            ...
            { "ToggleAnimalMode", new ButtonArea(new Rect(1790, 30, 100,100),ActionToggleAnimalMode) }
        };
    ...
    public void StartGame()
    {
        buttonAreas = new Dictionary<string, ButtonArea>
        {
            ...
            { "HoldObj", new ButtonArea(new Rect(1535, 15, 150, 150), ActionHold, 1) },
        };
        props["isCameraMoving"] = false;
        props["isRotateMode"] = false;
        props["isAnimalMode"] = GameManager.instance.isOnlyAnimals;
    ...
    public void ShowRanking()
    {
        buttonAreas = new Dictionary<string, ButtonArea>
        {
            { "NextPage", new ButtonArea(new Rect(1690, 890, 140, 140), GameManager.instance.scoreManager.NextPage) },
            { "PreviousPage", new ButtonArea(new Rect(90, 890, 140, 140), GameManager.instance.scoreManager.PreviousPage) },
            { "TitleButton", new ButtonArea(new Rect(1710, 70, 100, 100), ActionToTitle, 1) }
        };
